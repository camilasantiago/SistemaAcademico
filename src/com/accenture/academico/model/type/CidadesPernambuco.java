...
public enum CidadesPernambuco {
	...
	RECIFE("Recife", 10), CARUARU("Caruaru", 9), OLINDA("Olinda", 8), GARANHUNS("Garanhuns", 7), ARCOVERDE("Arco-verde",
			6), GOIANA("Goiana", 5), GRAVATA("Gravatá", 4), JABOATAODOSGUARARAPES("Jaboatão dos Guararapes",
					3), CARPINA("Carpina", 2), LIMOEIRO("Limoeiro", 1);
